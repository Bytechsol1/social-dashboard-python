...
class InstagramService:
    ...
    async def get_user_id(self) -> Optional[str]:
        ...
        try:
            # First, get the list of Facebook Pages managed by the user
    ...
    async def get_user_insights(self, ig_user_id: str) -> List[Dict]:
        ...
        Period=day provides daily data, but sometimes fails for new accounts.
        Period=days_28 is often more reliable for summary stats.
        """
        async with httpx.AsyncClient() as client:
